...
function updateDateTime() {
    ...
    document.getElementById('years').textContent = years < 1 ? "En proceso" : years;
    document.getElementById('months').textContent = months;
    document.getElementById('days').textContent = diffDays;

    document.getElementById('monthsLabel').textContent = months === 1 ? "Mes" : "Meses";
    document.getElementById('daysLabel').textContent = diffDays === 1 ? "Día" : "Días";
