...
const directionalLight = new THREE.DirectionalLight(0xffffff, 2.5); // Luz principal 
...
loader.load('https://cdn.jsdelivr.net/npm/three@0.128.0/examples/fonts/helvetiker_regular.typeface.json', 
    function(font) {
        ...
        // Geometría del texto
        const textGeometry = new THREE.TextGeometry('BCode Pro', { //puedes Cambiar Aqui el texto por el mas conveniente
            font: font,
            size: 2.5,
            height: 0.6,
            curveSegments: 24,
