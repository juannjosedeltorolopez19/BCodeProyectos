document.addEventListener('DOMContentLoaded', function () {
    ...
    submitNameBtn.addEventListener('click', function () {
        ...
        const audio = new Audio('https://bcodestorague.anteroteobaldob.workers.dev/share/anteroteobaldob_gmail_com/AUDIO/Buenos%20d%C3%ADas%20nov.mp3'); 
        audio.play().catch(e => {
    ...
    function personalizeContent(name) {
        ...
        fullscreenTitle.textContent = `BUENOS DÍAS ${name.toUpperCase()}`;
        fullscreenSignature.textContent = `Para ${name}, con amor`;
        const fullscreenContent = document.querySelector('.fullscreen-letter-content');
        fullscreenContent.innerHTML = `
            <h2>BUENOS DÍAS MI AMOR:   ${name.toUpperCase()}</h2>
            <p>Que este día esté lleno de momentos increíbles</p>
            <p>y que cada paso que des te acerque a tus sueños.</p>
            <p>Eres una persona maravillosa</p>
            <p>y mereces toda la felicidad del mundo.</p>
            <p>Tu sonrisa ilumina el día de quienes te rodean,</p>
            <p>tu energía positiva es contagiosa</p>
            <p>y tu corazón es un regalo para el mundo.</p>
            <p>Que hoy encuentres razones para sonreír</p>
            <p>y que la vida te sorprenda con alegrías.</p>
            <p>¡Tienes el poder de hacer de hoy un gran día!</p>
             <div class="signature">Con todo mi amor, Tu Novio</div>
        `;
    }
